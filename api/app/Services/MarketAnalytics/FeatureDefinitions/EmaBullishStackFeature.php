...
/**
 * EMA Bullish Stack Feature
 *
 * This feature checks whether short and long EMAs are aligned
 * in bullish order:
 *
 * EMA 20 > EMA 50 > EMA 100 > EMA 200
 *
 * It is commonly used to confirm strong bullish trend structure.
 */
class EmaBullishStackFeature implements AnalyticFeatureInterface
{
    public function key(): string
    {
        return 'ema_bullish_stack';
    }
